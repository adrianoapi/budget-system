                                ...
                                @foreach ($companies as $value)
                                    <tr>
                                        ...
                                        <td class='hidden-1024'>
                                            {{ Form::open(['route' => ['empresas.destroy', $value->id],  'method' => 'POST', "onSubmit" => "return confirm('Deseja excluir?');", 'style' => 'margin: 0;padding:0;']) }}
                                                @csrf
                                                @method('delete')
                                                <a href="{{route('empresas.edit', $value->id)}}" class="btn" rel="tooltip" title="" data-original-title="Editar">
                                                    <i class="icon-edit"></i>
                                                </a>
